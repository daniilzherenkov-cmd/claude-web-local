...
# Keep the bundle unsigned so Gatekeeper shows "unidentified developer"
# (right-click → Open) rather than "damaged" (no bypass).
codesign --remove-signature ClaudeLocal.app 2>/dev/null || true
